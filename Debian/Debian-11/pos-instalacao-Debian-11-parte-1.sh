...
if [ -e /home/$USER/Modelos/shell-script.sh ];then
    ...
    echo '#!/bin/bash' | tee /home/$USER/Modelos/shell-script.sh
fi
...
sudo apt install -y unrar-free p7zip ark ncompress
...
if [ -e eclipse-jee-2022-09.deb ];then
    ...
    curl -L -o eclipse-jee-2022-09.deb https://www.dropbox.com/s/trr4dlqkq8ahs74/eclipse-jee-2022-09.deb?dl=0
fi
...
## Download Insync
echo -e "\n\n\n Insync"
if [ -e insync_3.8.4.50481-bullseye_amd64.deb ];then
    echo "O arquivo  insync_3.8.4.50481-bullseye_amd64.deb ja existe"
else
    curl -L -o insync_3.8.4.50481-bullseye_amd64.deb https://www.dropbox.com/s/r6usirkdxe4p0bz/insync_3.8.4.50481-bullseye_amd64.deb?dl=0
fi
...
## Download VirtualBox
echo -e "\n\n\n VirtualBox"
if [ -e virtualbox-6.1_Debian_bullseye_amd64.deb ];then
    echo "O arquivo  virtualbox-6.1_Debian_bullseye_amd64.deb  ja existe"
else
    curl -L -o virtualbox-6.1_Debian_bullseye_amd64.deb https://www.dropbox.com/s/yye4cymvu4er4h8/virtualbox-6.1_Debian_bullseye_amd64.deb?dl=0
fi
...
## Instalando libfuse2
## Arquivos do tipo AppiMAGER
## precisam deste pacote
