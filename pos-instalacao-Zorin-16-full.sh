...
then
    ...
    curl -L -o Apache-NetBeans-12.4-bin-linux-x64.sh https://www.dropbox.com/s/wgfddl7vvr44k88/Apache-NetBeans-12.4-bin-linux-x64.sh?dl=0
fi
...
## Download DBeaver
echo -e "\n\n\n DBeaver - 95 MB"
if [ -e dbeaver-ce_21.2.0_amd64.deb ]
then
    echo "O arquivo  dbeaver-ce_21.2.0_amd64.deb  ja existe"
else
    curl -L -o dbeaver-ce_21.2.0_amd64.deb https://www.dropbox.com/s/s4a8vted1rsn0b6/dbeaver-ce_21.2.0_amd64.deb?dl=0
fi
...
then
    echo "O arquivo jdk-11.0.12_linux-x64_bin.debja existe"
else
    curl -L -o jdk-11.0.12_linux-x64_bin.deb https://www.dropbox.com/s/sxkvl6273kbdr8k/jdk-11.0.12_linux-x64_bin.deb?dl=0
...
## Download Waterfox
echo -e "\n\n\n WebStorm - 377 MB"
if [ -d WebStorm-212.5080.54 ]
then
    sudo cp -r WebStorm-212.5080.54 /opt/
else
    curl -L -o WebStorm-212.5080.54.tar.xz https://www.dropbox.com/s/9uiydzq19rgh7xj/WebStorm-212.5080.54.tar.xz?dl=0

    tar xvf WebStorm-212.5080.54.tar.xz
    sudo cp -r WebStorm-212.5080.54 /opt/
fi
...
if [ -d /home/$USER/Imagens/wallpaper/ ];then
   echo "O diretorio  /home/$USER/Instalacao/wallpaper/  ja existe"
...
if [ -d /home/luciano/.themes/Kripton ];then
   echo "O diretorio  -e /home/luciano/.themes/Kripton  ja existe"
...
if [ -d /home/luciano/.icons/Neon-Ultra ];then
   echo "O diretorio  /home/luciano/.icons/Neon-Ultra  ja existe"

elif [ -d Neon-Ultra ];then
...
sudo dpkg -i dbeaver-ce_21.2.0_amd64.deb
sudo apt --fix-broken install -y
...
echo -e "\n\n******************** INSTALANDO  O  WEB STORM ********************"


echo "[Desktop Entry]" | sudo tee /usr/share/applications/web-storm.desktop
echo "Comment=" | sudo tee -a /usr/share/applications/web-storm.desktop
echo "Terminal=false" | sudo tee -a /usr/share/applications/web-storm.desktop
echo "Name=WebStorm" | sudo tee -a /usr/share/applications/web-storm.desktop
